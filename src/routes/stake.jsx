    ...
    <section>
      <Modal
        ...
        content={
          <ListItem
            items={tokens}
            onItemSelected={handleTokenSelection}
          />
        }
      />
        ...
        <div className="flex flex-col gap-6 px-4 py-6 mt-2 border rounded-xl border-black/30 dark:border-white/10">
          ...
          <div className="flex flex-row items-center justify-between">
            ...
            <span className="flex-1 text-lg font-medium text-black dark:text-white">
              Stake LP to earn incentive reward
            </span>
          ...
          <div className="flex flex-col w-full gap-4 text-sm font-medium">
            <span className="text-lg text-black dark:text-white">Select Liquidity</span>
            <label
            ...
            >
              {token ? (
                ...
                <span className="flex items-center h-full text-lg">Select a token</span>
              )}
            </label>
          </div>
          {/* Amount Input */}
          ...
          <div className="form-group">
            <label className="form-label text-lg text-black dark:text-white">Stake </label>
          ...
          {/* Interest Fee */}
          <div className="form-group">
            <label htmlFor="interestFee">APR </label>
          </div>
          {/* Borrow Button */}
          <Button
